...
load csv with headers from "file:///D:/Users/krainov/Documents/soft/java/workspaces_idea/yesdo/yesdo/graph/src/main/resources/data/scripts/batch/activity_data.csv" as row
...
load csv with headers from "file:///D:/Users/krainov/Documents/soft/java/workspaces_idea/yesdo/yesdo/graph/src/main/resources/data/scripts/batch/merchant_data.csv" as row
with row,
...
load csv with headers from "file:///D:/Users/krainov/Documents/soft/java/workspaces_idea/yesdo/yesdo/graph/src/main/resources/data/scripts/batch/product_data.csv" as row
with row
merge (m1:Merchant {title: row.title_merchant})
